...
import vShader from '../webgl/shaders/vertex/v-10.glsl';
import fShader from '../webgl/shaders/fragment/f-10.glsl';
...
export default {
  ...
  methods: {
    ...
    */
    ...
    createPlane() {
      const scaleRatio = 190;
      const aspectRatio = {
        width: 130 / scaleRatio,
        height: 87 / scaleRatio,
      };

      const geometry = new THREE.PlaneGeometry(aspectRatio.width, aspectRatio.height);
      const textureLoader = new THREE.TextureLoader();
      const path = require('@/assets/texture_two.png');
